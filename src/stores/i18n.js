...
export const translations = {
  en: {
    ...
    btnStartNextMonth: "Start Next Month",
    startDate: "Start Date",
    endDate: "End Date",
    topSpendingCategories: "Top 5 Spending Categories",
    noHistory: "No archived history available.",
    viewReport: "View Report",
    archivedReportTitle: "Monthly Report ({start} to {end})",
    resetMonthConfirm: "Are you sure you want to archive and reset the current month? This will clear active transactions and incomes.",
    resetMonthHeader: "Archive & Reset Month",
    startNextMonthConfirm: "Are you sure you want to initialize the state for the new month?",
    startNextMonthHeader: "Start Next Month",
    toastArchived: "Month successfully archived and reset",
    toastNextMonthStarted: "New month initialized successfully",

    // Check Calculator
    checkCalculator: "Check Calculator",
    btnNewCheck: "Add New Check",
    uploadCheckImage: "Upload Check Image",
    ocrTodoComment: "Future Feature: OCR Receipt scanning can be implemented here.",
    ...
    btnSaveCheck: "Save Check",
    numberParticipants: "Number of Participants",
    paid: "Paid",
    pending: "Wait for Paying",
    ...
    checkFullyPaidHeader: "Check Fully Paid!",
    checkFullyPaidMsg: "Everyone has paid successfully. Great job!",
    completed: "Completed",
    ...
    averageCheckValue: "Avg Check Value",
    searchParticipants: "Search participants...",
    editParticipant: "Edit Participant",
    confirmDeleteCheckMsg: "Are you sure you want to delete this check?",

    // Payment Dispatcher
    paymentDispatcher: "Payment Link Dispatcher",
    paymentLinks: "Saved Payment Links",
    btnAddNewLink: "Add Alternative Link",
    selectContact: "Select Contact from Phone",
    contactSelected: "Selected Contact Details",
    contactName: "Contact Name",
    contactPhone: "Phone Number",
    selectPaymentLink: "Select Payment Link",
    btnSendWhatsApp: "Send via WhatsApp",
    manualEntry: "Manual Contact Entry",
    manualEntryDesc: "Please enter the name and phone number below.",
    noContactSelected: "No contact selected yet.",
    dialogAddTitle: "Add Alternative Link",
    dialogEditTitle: "Edit Payment Link",
    labelInput: "Label (e.g. My Instapay)",
    urlInput: "URL Link",
    validationLabelRequired: "Label is required.",
    validationUrlRequired: "URL is required.",
    makeDefault: "Make Default",
    toastLinkAdded: "Link added successfully",
    toastLinkUpdated: "Link updated successfully",
    toastLinkDeleted: "Link deleted successfully",
    toastLinkDefaultSet: "Default link set successfully",
    whatsAppTemplate: "Hey {name}! Here is the link for the payment: {url}",
    whatsAppTemplateWithAmount: "Hey {name}! Here is the link for the payment: {url}. Amount to pay: {amount} EGP"
  },
  ar: {
    // Navigation
    ...
    // Monthly Cycle & History
    history: "السجل",
    btnResetMonth: "إعادة ضبط الشهر",
    btnStartNextMonth: "بدء الشهر التالي",
    startDate: "تاريخ البدء",
    endDate: "تاريخ الانتهاء",
    topSpendingCategories: "أعلى 5 فئات إنفاق",
    noHistory: "لا يوجد سجل مؤرشف متاح.",
    viewReport: "عرض التقرير",
    archivedReportTitle: "التقرير الشهري ({start} إلى {end})",
    resetMonthConfirm: "هل أنت متأكد من أرشفة وإعادة تعيين الشهر الحالي؟ سيؤدي هذا لمسح المعاملات والمداخيل النشطة.",
    resetMonthHeader: "أرشفة وإعادة ضبط الشهر",
    startNextMonthConfirm: "هل أنت متأكد من تهيئة الحالة للشهر الجديد؟",
    startNextMonthHeader: "بدء الشهر التالي",
    toastArchived: "تم أرشفة وإعادة تعيين الشهر بنجاح",
    toastNextMonthStarted: "تمت تهيئة الشهر الجديد بنجاح",

    // Check Calculator
    checkCalculator: "حاسبة الفاتورة",
    btnNewCheck: "إضافة فاتورة جديدة",
    uploadCheckImage: "تحميل صورة الفاتورة",
    ocrTodoComment: "ميزة مستقبلية: يمكن تطبيق مسح الفاتورة الذكي هنا.",
    restaurantName: "اسم المطعم",
    checkTitle: "عنوان الفاتورة",
    taxIncluded: "شامل الضريبة",
    taxAmount: "قيمة الضريبة",
    grandTotal: "المجموع الكلي",
    addParticipant: "إضافة مشارك",
    btnSaveCheck: "حفظ الفاتورة",
    numberParticipants: "عدد المشاركين",
    paid: "مدفوع",
    pending: "بانتظار الدفع",
    statusPendingSetup: "لم يطلب بعد",
    ...
    progress: "التقدم",
    finishCheck: "إنهاء الفاتورة",
    checkFullyPaidHeader: "تم دفع الفاتورة بالكامل!",
    checkFullyPaidMsg: "قام الجميع بالدفع بنجاح. عمل رائع!",
    completed: "مكتمل",
    checkHistory: "سجل الفواتير",
    completionTime: "وقت الإتمام",
    btnViewDetails: "عرض التفاصيل",
    totalChecks: "إجمالي الفواتير",
    completedChecks: "الفواتير المكتملة",
    pendingChecks: "الفواتير المعلقة",
    moneyCollected: "المبالغ المحصلة",
    moneyRemaining: "المبالغ المتبقية",
    averageCheckValue: "متوسط الفاتورة",
    confirmDeleteCheckMsg: "هل أنت متأكد من رغبتك في حذف هذه الفاتورة؟",

    // Payment Dispatcher
    paymentDispatcher: "مرسل رابط الدفع",
    paymentLinks: "روابط الدفع المحفوظة",
    btnAddNewLink: "إضافة رابط بديل",
    selectContact: "اختر جهة اتصال من الهاتف",
    contactSelected: "تفاصيل جهة الاتصال المختارة",
    contactName: "اسم جهة الاتصال",
    contactPhone: "رقم الهاتف",
    selectPaymentLink: "اختر رابط الدفع",
    btnSendWhatsApp: "إرسال عبر واتساب",
    manualEntry: "إدخال جهة اتصال يدوياً",
    manualEntryDesc: "يرجى إدخال الاسم ورقم الهاتف بالأسفل.",
    noContactSelected: "لم يتم اختيار جهة اتصال بعد.",
    dialogAddTitle: "إضافة رابط بديل",
    dialogEditTitle: "تعديل رابط الدفع",
    labelInput: "العنوان (مثال: إنستاباي الخاص بي)",
    urlInput: "رابط URL",
    validationLabelRequired: "العنوان مطلوب.",
    validationUrlRequired: "الرابط مطلوب.",
    makeDefault: "تعيين كافتراضي",
    toastLinkAdded: "تم إضافة الرابط بنجاح",
    toastLinkUpdated: "تم تحديث الرابط بنجاح",
    toastLinkDeleted: "تم حذف الرابط بنجاح",
    toastLinkDefaultSet: "تم تعيين الرابط الافتراضي بنجاح",
    whatsAppTemplate: "مرحباً {name}! هذا هو رابط الدفع: {url}",
    whatsAppTemplateWithAmount: "مرحباً {name}! هذا هو رابط الدفع: {url}. المبلغ المطلوب دفعه: {amount} جنيه"
  }
};
